...
namespace BlazorSozluk.WebApp.Infrastructure.Extensions
{
    public static class LocalStorageExtension
    {
        ...
        public static async void SetUsername(this ISyncLocalStorageService localStorageService, string value)
        {
        ...
        public static async Task SetUserId(this ILocalStorageService localStorageService)
        {
            await localStorageService.GetItemAsync<Guid>(UserId);
        }
